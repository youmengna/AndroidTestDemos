...
import com.youmengna.byr.adapter.*;
...
//    private List<Board> board_subsection=new ArrayList<>();
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (rootSection.getBoard() != null && rootSection.getSub_section() != null) {
            if (childPosition < 1) {
                ...
                View view = getGenericView_Board(rootSection.getBoard().get(childPosition - 1).getDescription());
                return view;
            }
        } else if (rootSection.getBoard() != null && rootSection.getSub_section() == null) {
            return getGenericView_Board(rootSection.getBoard().get(childPosition).getDescription());
        } else if (rootSection.getBoard() == null && rootSection.getSub_section() != null) {
            return getGenericExpandableListView(rootSection);
        } else {
            return null;
    ...
    private View getGenericView_Board(String string) {
...
///
    ...
    public ExpandableListView getGenericExpandableListView(final Section rootSection) {
        ...
        final com.youmengna.byr.adapter.SubSectionExpandableListViewAdapter adapter = new com.youmengna.byr.adapter.SubSectionExpandableListViewAdapter(rootSection.getSub_section(), board_subsection, activity);
    ...
    class MyRequestListener implements RequestListener {
        com.youmengna.byr.adapter.SubSectionExpandableListViewAdapter mAdapter;

        public void setadapter(com.youmengna.byr.adapter.SubSectionExpandableListViewAdapter adapter) {
            mAdapter = adapter;
        }
...
//                Gson gson = new Gson();
//                final Section subSectionInfo = gson.fromJson(response, Section.class);
//                handler.obtainMessage(SUCEESS, subSectionInfo).sendToTarget();
//                handler.post(new Runnable() {
//                    @Override
//                    public void run() {
//                        board_subsection=subSectionInfo.getBoard();
